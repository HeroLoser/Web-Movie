  ...
  <body>
    ...
    <div class="container">
      ...
      <nav class="navbar navbar-dark bg-dark">
        <strong class="navbar-brand">Movie</strong>
          <form class="form-inline">
            <input class="form-control mr-sm-2" type="search" placeholder="Search" id="search-input">
            <button class="btn btn-primary my-2 my-sm-0" type="button" id="search-button">Search</button>
          </form>
      </nav>


      <h2 class="text-center mt-3 mb-3">List Movie</h2>
      <hr class="w-100">
